...
# Production Database Seeding Script for MatchGrinder
# This script seeds the production database with comprehensive test data
...
SERVER_PASS="maryjane4u"
REMOTE_DIR="/customers/f/b/1/c9k0rtix9/webroots/c91f3683/api"

# Connect to server and run seeding
echo "🚀 Connecting to production server and running database seeding..."
