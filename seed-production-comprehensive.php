...
echo "🌱 Starting comprehensive production seeding...\n";
...
// Create more game events
if (GameEvent::count() < 10) {
    echo "🎮 Creating more game events...\n";
    $venues = [
...
if (Discussion::count() < 10) {
    echo "💬 Creating more discussions...\n";
    $topics = [
    ...
    foreach ($users as $index => $user) {
        ...
        Discussion::create([
            ...
            'body' => 'I would love to discuss this topic with fellow sports enthusiasts. What are your thoughts and experiences?',
...
if (Tournament::count() === 0) {
    ...
    $tournaments = [
        [
            'name' => 'London Basketball Championship',
        ...
        [
            ...
            'description' => 'Open tennis tournament for intermediate players',
            'sport' => 'Tennis',
        ...
        [
            ...
            'description' => 'Local football league cup competition',
            'sport' => 'Football',
            'skill_level' => 'Mixed',
...
if (Conversation::count() < 5) {
    ...
    for ($i = 0; $i < 8; $i++) {
        ...
        if ($user1->id !== $user2->id) {
            ...
            $messages = [
                ...
                'Great! Are you interested in joining our game this weekend?',
                'That sounds perfect! What time works for you?',
                'I think 2 PM would be ideal. See you there!',
                'Looking forward to it! Don\'t forget your gear.',
                'Will do! Thanks for organizing this.',
                'No problem! It\'s going to be fun.',
                'Absolutely! Can\'t wait to play with everyone.',
            ];
            ...
            for ($j = 0; $j < rand(3, 8); $j++) {
                ...
                Message::create([
                    ...
                    'content' => $messages[$j % count($messages)],
    ...
    for ($i = 0; $i < 3; $i++) {
        ...
        $groupMessages = [
            ...
            'Great! Anyone up for a game this weekend?',
            'I\'m in! What time works for everyone?',
            '2 PM sounds good to me.',
            'Perfect! I\'ll bring the equipment.',
            'Don\'t forget to invite the new members!',
        ...
        for ($j = 0; $j < rand(5, 12); $j++) {
            ...
            Message::create([
                'conversation_id' => $conversation->id,
                'user_id' => $messageUser->id,
                'content' => $groupMessages[$j % count($groupMessages)],
...
if (GameEventParticipant::count() < 10) {
...
echo "✅ Comprehensive production seeding completed!\n";
...
echo "\n🎉 Comprehensive production seeding completed successfully!\n";
